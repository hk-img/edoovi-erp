        ...
        <div className="view">
          <div className="flex flex-col">
            <h2 className="md:w-8/12 w-full 2xl:text-5xl mx-auto xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl text-2xl font-bold text-white text-balance relative z-10 text-center md:pb-8 pb-4">
              How Our{" "}
              <span className="text-[#04D9FF]"> AI-Driven School ERP </span> Has
            ...
            <div className="flex flex-row md:items-end">
              <div className="md:w-1/3 md:block hidden">
                <div className="w-full">
                  <Image
                    ...
                    alt="How Our AI-Driven School ERP Has Unbelievable Outcomes"
                    width={400}
                    height={479}
              ...
              <div className="flex md:w-2/3 w-full flex-col md:sticky md:bottom-0 xl:py-4 lg:py-3 py-4 lg:ps-8 md:ps-6 relative">
                ...
                >
                    ...
                    <div className="flex flex-col p-6 relative  rounded-2xl  bg-gradient-to-r from-[#0EAFF0] to-[#0EAFF0]  h-full">
                      ...
                      <div className="flex flex-col ">
                        ...
                        <div className="flex flex-row pt-3.5 justify-between">
                          <ul className="text-white text-xs pl-3 font-normal space-y-2 list-disc">
                            <li>
                              AI-Powered Fee Collection System Makes Payments
                            </li>
                            <li>Easy & Simple for Schools and Parents</li>
                            <li>AI Powers Deduction Alerts</li>
                            <li>Alerts sent via WhatsApp, SMS and in-app</li>
                            <li>Multiple payment modes, including UPI</li>
                            <li>
                              Real-time updates in ERP after payment is
                              collected
                            </li>
                          </ul>
                          <div className="">
                  ...
                  <div className="embla__slide  shrink-0 px-2 basis-[100%] lg:basis-[50%] ">
                    <div className="flex flex-col p-6 relative  rounded-2xl  bg-gradient-to-r from-[#FFFFFF] to-[#C0F0FF]  h-full">
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="flex flex-row pt-3.5 justify-between">
                          <ul className="text-[#190F4E] text-xs pl-3 font-normal space-y-2 list-disc">
                            <li>AI-Based Exam Module Does it Smartly</li>
                            <li>Fee Reminders generated by AI</li>
                            <li>Alerts sent via WhatsApp, SMS, in-app</li>
                            <li>Hassle-free cross-payment modes, UPI</li>
                          </ul>
                          <div className="">
                            <Image
                              src="/images/dolorImg.webp"
                  ...
                  <div className="embla__slide  shrink-0 px-2 basis-[100%] lg:basis-[50%] md:hidden flex">
                    <div className="flex flex-col p-6 relative  rounded-2xl bg-gradient-to-bl from-[#190F4E] to-[#393A8C] h-full">
                      <div className="top-0 absolute right-0">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="size-20"
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="flex flex-row pt-3.5 justify-between">
                          <ul className="text-white text-xs pl-3 font-normal space-y-2 list-disc ">
                            <li>AI sends reminders about due fees</li>
                            <li>
                              Avoid fee notifications being lost. Alerts sent
                              via whatsapp, SMS or in-app
                            </li>
                            <li>
                              Payment mode choices including, but not limited
                              to, UPI
                            </li>
                            <li>
                              Seamlessly automates the updates to the ERP after
                              payment collection
                            </li>
                          </ul>
                          <div className="">
                  ...
                  <div className="flex justify-center items-center mb-2 gap-5 ">
                    ...
                    <div className="w-2/3 flex flex-row justify-between items-center pe-10">
                      <ul className="text-white text-xs pl-3 font-normal flex flex-col gap-y-4 list-disc">
                        <li>AI sends reminders about due fees</li>
                        <li>
                          Avoid fee notifications being lost. Alerts sent via
                          whatsapp, SMS or in-app
                        </li>
                        <li>
                          Payment mode choices including, but not limited to,
                          UPI
                        </li>
                        <li>
                          Seamlessly automates the updates to the ERP after
