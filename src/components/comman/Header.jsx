                ...
                <div className="flex flex-col w-full gap-y-5 p-5">
                  ...
                  <div className="relative w-full mt-3 flex justify-center items-center">
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="cursor-pointer w-full rounded-full bg-[#00BBF5] text-sm text-white h-10 flex  items-center justify-center px-6 py-2 hover:bg-[#25b7e3] font-semibold duration-300"
                    >
                      Download Brochure
                    </Link>
                  </div>
